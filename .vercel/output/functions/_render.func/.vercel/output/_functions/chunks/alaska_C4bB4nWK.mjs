...
const html = "";
				...
				const frontmatter = {"state":"Alaska","description":"Comprehensive virtual speech therapy services available across Alaska. Our remote therapy solutions bring professional speech services to both urban and rural communities throughout the state.","services":["Speech Sound Disorders","Language Delays","Stuttering Therapy","Voice Therapy","Accent Modification","Social Communication"],"virtualPlatforms":["Zoom for Healthcare","Microsoft Teams","Doxy.me"],"coverage":["All major insurance providers","Medicare","Medicaid","Denali KidCare"],"contact":{"phone":"(907) 555-0123","email":"alaska@falconspeech.com"}};
