...
const $$Oregon = createComponent(async ($$result, $$props, $$slots) => {
  const oregonData = await getEntry("locations", "oregon");
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Speech Therapy Services in Oregon | Falcon Speech Services" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-7xl mx-auto"> <!-- Header --> <div class="text-center mb-12"> <h1 class="text-4xl font-bold text-gray-900 mb-4">Speech Therapy Services in Oregon</h1> <p class="text-lg text-gray-600 max-w-3xl mx-auto">
Professional virtual speech therapy services throughout Oregon. Our hybrid therapy services (in-home evaluations + virtual sessions) are specifically focused on Columbia River Gorge communities.
...
</a> <a href="/services/remote/oregon" class="border border-primary text-primary px-8 py-3 rounded-lg font-medium hover:bg-primary-50">
Learn More About Virtual Services
</a> </div> </div> </div> ` })}`;
}, "/Users/falcon/seo_python/falcon_speech_services/src/pages/locations/oregon.astro", undefined);

const $$file = "/Users/falcon/seo_python/falcon_speech_services/src/pages/locations/oregon.astro";
const $$url = "/locations/oregon";
