...
const ForkApprovalContainer = /*#__PURE__*/(0, _base.default)("div", {
  target: "e1ko648l1",
...
const ForkButtonsContainer = /*#__PURE__*/(0, _base.default)("div", {
  target: "e1ko648l0",
...
class GitHubAuthenticationPage extends _react.default.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "renderLoginButton", () => {
      ...
      return inProgress || this.state.findingFork ? t('auth.loggingIn') : (0, _react2.jsx)(_react.default.Fragment, null, (0, _react2.jsx)(LoginButtonIcon, {
        type: "github"
    ...
    if (requestingFork) {
      ...
      return {
        renderPageContent: ({
          ...
          TextButton,
          showAbortButton
        }) => (0, _react2.jsx)(ForkApprovalContainer, null, (0, _react2.jsx)("p", null, "Open Authoring is enabled: we need to use a fork on your github account. (If a fork already exists, we'll use that.)"), (0, _react2.jsx)(ForkButtonsContainer, null, (0, _react2.jsx)(LoginButton, {
          onClick: approveFork
        }, "Fork the repo"), showAbortButton && (0, _react2.jsx)(TextButton, {
          onClick: refuseFork
        }, "Don't fork the repo")))
      };
    }
  ...
  render() {
    ...
    return (0, _react2.jsx)(_decapCmsUiDefault.AuthenticationPage, _extends({
